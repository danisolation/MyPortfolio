...
export const projects: Project[] = [
  {
    ...
    media: [
      { type: "image", url: "/images/shub.webp" },
      { type: "image", url: "/images/MainScreen.webp" },
      { type: "image", url: "/images/Setting.webp" },
      { type: "image", url: "/images/UserManage.webp" },
    ],
  },
  {
    id: 2,
    ...
    media: [
      { type: "image", url: "/images/forsaken.webp" },
      { type: "image", url: "/images/webdashboard.webp" },
      { type: "image", url: "/images/sensorweb.webp" },
      { type: "image", url: "/images/conditionerweb.webp" },
    ],
  },
  {
    id: 3,
  ...
  },
  {
    ...
    role: ["Back-end Developer"],
    media: [
      { type: "image", url: "/images/CS.webp" },
      { type: "image", url: "/images/login.webp" },
      { type: "image", url: "/images/first.webp" },
      { type: "image", url: "/images/cd.webp" },
      { type: "image", url: "/images/dl.webp" },
      { type: "image", url: "/images/hoso.webp" },
      { type: "image", url: "/images/user.webp" },
    ],
  },
  {
    id: 5,
